...
public class Query7A {
    ...
    public void ProcessQuery(){
        ...
        try{
            String query = "Select hh.catch_fish_loc as \"Fishing Location\",equip.aquaequiptype as \"Equipment Used\" , sum(animals.aquani_vol) as \"Total Volume per location\"\n" +
                            ...
                            "group by hh.catch_fish_loc, equip.aquaequiptype"; //Add query here
