...
public class Query7A {
    ...
    public void ProcessQuery(){
        ...
        try{
            String query = "Select hh.catch_fish_loc as \"Fishing Location\", sum(animals.aquani_vol) as \"Total Volume per location\"\n" +
                            ...
                            "group by hh.catch_fish_loc"; //Add query here
